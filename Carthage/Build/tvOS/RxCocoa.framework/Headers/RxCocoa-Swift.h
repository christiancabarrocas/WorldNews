...
@property (nonatomic, readonly) SEL _Null_unspecified selector;
@property (nonatomic, weak) UIGestureRecognizer * _Nullable gestureRecognizer;
@property (nonatomic, copy) void (^ _Nullable callback)(UIGestureRecognizer * _Nonnull);
- (nonnull instancetype)init:(UIGestureRecognizer * _Nonnull)gestureRecognizer callback:(void (^ _Nonnull)(UIGestureRecognizer * _Nonnull))callback OBJC_DESIGNATED_INITIALIZER;
- (void)eventHandler:(UIGestureRecognizer * _Null_unspecified)sender;
- (void)dispose;
@end
